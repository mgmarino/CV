...
\years{2012}Henderson Prize, Oustanding PhD Thesis, Physics Department, University of Washington

\years{2012}Recontres de Moriond Travel Grant, Electroweak Interactions and Unified Theories, La Thuile, Italy 
...
\years{2014} ``Results from EXO-200", Neutrino 2014, Boston, Massachusetts, USA. \emph{Invited Talk}

\years{2014} ``Neutrinos, the universe, and liquid Xe", Physikalisches Kolloquium, Physikalisches Institut, Universit\"{a}t Heidelberg, Heidelberg, Germany. \emph{Invited Talk}

\years{2014} ``Neutrinos, the universe, and liquid Xe", HeMe Seminar, University of Illinois, Urbana-Champaign, Illinois, USA. \emph{Invited Talk}

\years{2013} ``Liquid xenon, accelerators, and the neutrino", AEC Seminar on Particle Physics, AEC/LHEP, Universit\"{a}t Bern, Bern, Switzerland. \emph{Invited Talk}

\years{2013} ``Results of the EXO-200 neutrinoless double-beta decay experiment", R\'{e}unions Pleini\`{e}res du GDR Neutrino, Universit\'{e} Pierre et Marie Curie, Paris, France. \emph{Invited Talk}

\years{2013} ``Recent results of the EXO-200 neutrinoless double-beta decay experiment", MLL Kolloquium, Ludwig-Maximillian-Universits\"{a}t M\"{u}nchen, Garching, Germany. \emph{Invited Talk}

\years{2012} ``Searching for physics beyond the standard model: the neutron electric dipole moment experiment at the TUM", NPAC Forum, University of Wisconsin, Madison, Wisconsin. \emph{Invited Talk}

\years{2012} ``Recent results of the CoGeNT Dark Matter experiment", Recontres de Moriond, La Thuile, Italy. \emph{Invited Talk}

\years{2011} ``Neutrinoless double-beta decay", EXA2011 International Conference on Exotic Atoms and Related Topics, Vienna, Austria. \emph{Invited Talk}
...
\years{2013--2016} ``Development of simulation, data acquisition and analysis systems for the next-generation measurement of the neutron EDM", Schwerpunktprogramme 1491, Deutsche Forschungsgemeinschaft. 
...
\years{2010--present} \emph{Postdoktorand}, EXC `Universe', \TUM, Munich, Germany\\
  Junior Research Group of Peter Fierlinger
\begin{packed_enum}
	\item Member and Analysis Coordinator (Sept 2012--present) of the EXO~collaboration (Analysis and Simulation software development)
	\item Member and Technical Coordinator of the TUM nEDM experiment (DAQ hardware and software development)
\end{packed_enum}	
...
\years{2011--2013}{Advised Masters Theses (2) and Bachelor Theses (3), \TUM} 

\years{2012,2013}{Experimentalphysik f\"{u}r Elektrotechnik (Experimental physics for electrical engineers), Central tutorial (all students, German), 10 sessions.  \TUM} 

\years{2011,2012}{Kern-,Teilchen-, und Astrophysik (Nuclear-, particle-, and astrophysics) 1/2. Tutorial session leader, \TUM} 
