...
\usepackage[dvipdfm, bookmarks, colorlinks, breaklinks, pdftitle={Michael Marino - vita},pdfauthor={Michael Marino}]{hyperref}  
...
%%\hrule
\section*{Education}
\noindent\years{2010}\textsc{PhD} in Physics, University of Washington, Seattle, Washington

\noindent\years{2005}\textsc{MSc} in Physics, University of Washington, Seattle, Washington

\noindent\years{2004}\textsc{BS} in Physics, \emph{Summa cum laude}, University of Notre Dame, Notre Dame, Indiana

\noindent\years{2004}\textsc{BA} in Philosophy, \emph{Summa cum laude}, University of Notre Dame, Notre Dame, Indiana

%%\hrule
\section*{Awards \amper{} honors}

\noindent\years{2007}Sebastian Karrer Prize, Physics Department, University of Washington

\noindent\years{2006}DNP Travel Award, APS Meeting, Dallas, Texas

\noindent\years{2005}Sebastian Karrer Scholarship, Physics Department, University of Washington

\noindent\years{2004-2005}Mellam Fellowship, Physics Department, University of Washington

\noindent\years{2004}Outstanding Senior Physics Major Award, Physics Department, University of Notre Dame

\noindent\years{2004}Elected Member, Phi Beta Kappa, Notre Dame Chapter, Epsilon of Indiana
...
\noindent\years{2010}``Searching for low-mass WIMPs: Dark matter from the tabletop", E-18 Seminar, \TUM, Garching, Germany. \emph{Invited Talk}

\noindent\years{2010}``Searching for low-mass WIMPs: Dark matter from the tabletop", Research Progress Seminar, Physics Division, Lawrence Berkeley National Laboratory, Berkeley, California. \emph{Invited Talk}

\noindent\years{2010}``Searching for low-mass WIMPs: Dark matter from the tabletop", Max-Planck-Institut f\"{u}r Physik, Munich, Germany \emph{Invited Talk}

\noindent\years{2010}``Searching for low-mass WIMPs: Dark matter from the tabletop", Max-Planck-Institut f\"{u}r Kernphysik, Heidelberg, Germany \emph{Invited Talk}

\noindent\years{2010}``Dark matter searches with low-noise ionization germanium detectors", Workshop on Germanium-Based Detectors and Technologies, Berkeley, California. \emph{Invited Talk}

\noindent\years{2010}``P-type point contact detectors for the \MJ~experiment", Los Alamos National Lab, Los Alamos, New Mexico. \emph{Invited Talk}

\noindent\years{2009}``The \MJ~neutrinoless double-beta decay experiment", DPF Meeting, Detroit, Michigan. \emph{Talk}

\noindent\years{2008}``Novel germanium detectors for the \MJ~experiment”, National Nuclear Physics Summer School, George Washington University, Washington, D.C.  \emph{Talk}

\noindent\years{2007}``Validation of neutron transportation and production in Geant4”, TRIUMF Summer Institute, Vancouver, British Columbia.  \emph{Talk}

\noindent\years{2006}``Implementation of a generic surface sampler using Geant4”, IEEE Nuclear Science Symposium, San Diego, California.  \emph{Poster}

\noindent\years{2006}``The proposed \MJ~$0\nu\beta\beta$ experiment”, Neutrino Conference 2006, San\-ta Fe, New Mexico.  \emph{Poster}

\noindent\years{2006}``An update on the \MJ-GERDA simulation package (MaGe)”, APS Meeting, Dallas, Texas.  \emph{Talk}

\noindent\years{2003}``ZFC/FC Simulations of Nano-clusters in Metallic Matrices”, Research Experience for Undergraduates Colloquium, University of Idaho.  \emph{Talk}

\noindent\years{2002}``Monte Carlo Analysis of UCN Transport Properties”, Research Experience for Undergraduates/Research Experience for Teachers Colloquium, University of Notre Dame.  \emph{Talk}

% new page to deal with funky page break
\newpage
% Professional experience
\section*{Relevant Professional Experience}
\noindent\years{2010-present}\emph{Postdoktorand}, Excellence Cluster `Universe', \TUM, Munich, Germany
\begin{packed_enum}
...
\end{packed_enum}	
\noindent\years{2005-2010}\emph{Graduate Research Assistant}, CENPA, University of Washington, Seattle, Washington\\ Advisor: John F. Wilkerson
\begin{packed_enum}
...
\noindent\years{2003}{\emph{Summer Research Assistant}, NSF Research Experience for Undergraduates Program, University of Idaho, Moscow, Idaho}\\ {Advisor: You Qiang}
\begin{packed_enum}
...
\noindent\years{2002}{\emph{Summer Research Assistant}, NSF Research Experience for Undergraduates Program, University of Notre Dame, Notre Dame, Indiana}\\{ Advisor: Alejandro Garcia}
\begin{packed_enum}
...
% new page to deal with funky page break
%\newpage
\noindent\years{2001-2002}{\emph{Tutor}, Learning Resource Center, University of Notre Dame, Notre Dame, Indiana}
\begin{packed_enum}
...
\noindent\years{2001-2002}{\emph{Lab Assistant}, Nuclear Structure Laboratory, University of Notre Dame, Notre Dame, Indiana}\\ {Advisor: Larry Lamm }
\begin{packed_enum}
...
\noindent\years{2008-2009}\emph{President}, Career Development Organization of Physicists and Astronomers, University of Washington, Seattle, Washington
\begin{packed_enum}
